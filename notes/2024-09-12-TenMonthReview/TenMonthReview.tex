...
\item A Triangle distribution (lower limit $0$ years, upper limit $8$ years, mode $6$ years) is used to model the service time at housing. This bounded unimodal distribution was chosen by \cite{singham2023discrete} to ensure a realistic number of people left housing during the simulation horizon of $5$ years. 
