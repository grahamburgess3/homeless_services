...
\end{itemize}
%
To sample the remaining housing service time for a customer already in housing at the start of the simulation, we use the procedure outlined in Algorithm \ref{alg:triang}. We here assume that we do not know how long those currently in housing have already been in service.
